...
function defaultFoods(){
  const mk = (name,category,calories,protein,carbs,fat)=>({id:uid(),name,category,calories,protein,carbs,fat,fiber:0,sodium:0,favorite:false,usageCount:0});
  return [
    mk("تشيز كيك مانجو","سناك",379.9,6,42,21),
    mk("تشيز كيك شوكلت","سناك",248.72,5,28,14),
    mk("تشيز كيك توت أزرق","سناك",266.6,5,30,15),
    mk("بودنق رايس","سناك",136.67,4,22,3),
    mk("كنافة صحية","سناك",318.54,7,38,15),
    mk("عريكة صحية","سناك",248,5,35,10),
    mk("كيك ليمون","سناك",167,3,26,5),
    mk("كيك ريد فلفيت","سناك",167,3,24,7),
    mk("تشيز كيك توت","سناك",298,6,32,16),
    mk("كرات الطاقة","سناك",190,5,18,10),
    mk("كيك براوني","سناك",120,2,16,5),
    mk("كنافة رول","سناك",113,2,14,5),
    mk("سناك مكسرات","سناك",130,4,8,10),
    mk("كنافة كرانش","سناك",125,3,15,6),
    mk("بسبوسة صحية","سناك",105,2,18,3),
    mk("تشيز كيك فراولة","سناك",379.9,6,40,22),
    mk("كيك شوكلت","سناك",167,3,24,7),
    mk("كرات اللحم","غدا",470.8,40,10,30),
    mk("لحم شيلي","غدا",456,48,10,24),
    mk("لحم ستيك مع مشروم","غدا",510,56,8,30),
    mk("ستيك مع صوص الفلفل الأسود","غدا",475.8,54,6,28),
    mk("دجاج باربيكيو","غدا",402.6,56,12,14),
    mk("دجاج برياني","غدا",368,48,10,16),
    mk("دجاج تندوري","غدا",573.4,60,12,34.8),
    mk("دجاج مشوي","غدا",374,60,4,14),
    mk("دجاج ليمون","غدا",368,56,8,12),
    mk("دجاج كريسبي","غدا",420,36,24,20),
    mk("دجاج شيلي","غدا",374,50,12,14),
    mk("دجاج أبولو","غدا",420,48,12,20),
    mk("دجاج فاهيتا","غدا",426,54,14,16),
    mk("لحم بامية","غدا",396,44,14,18.2),
    mk("دجاج بيتزا","غدا",420,48,16,18.2),
    mk("دجاج بامية","غدا",388,48,12,16.4),
    mk("دجاج زعتر","غدا",336,50,6,12.4),
    mk("صالونة سمك هامور","غدا",214,42,2,4.2),
    mk("كفتة دجاج","غدا",468,46,10,28),
    mk("دجاج كبسة","غدا",404,46,16,17.4),
    mk("شيش طاووق","غدا",442,56,8,20.2),
    mk("لحم فاهيتا","غدا",436,48,12,24.4),
    mk("ستيك لحم بالصوص الأبيض","غدا",532,54,8,34.2),
    mk("روبيان بالزعفران","غدا",214,40,4,4.2),
    mk("دجاج مندي","غدا",380,54,6,14),
    mk("دجاج رانش","غدا",368,52,8,14.2),
    mk("دجاج سيشوان","غدا",487,48,18,25.6),
    mk("سلمون مشوي","غدا",506,50,0,34),
    mk("دجاج مع ملوخية","غدا",394,50,12,16),
    mk("دجاج زبده","غدا",545,48,16,33),
    mk("كباب دجاج","غدا",374,52,6,16),
    mk("دجاج بالكاري","غدا",582.6,48,16,37.2),
    mk("جمبري مشوي","غدا",360,64,4,9.8),
    mk("صالونة سمك فيليه","غدا",274,46,4,9.2),
    mk("روبيان مع صوص الليمون والشبت","غدا",471.88,50,12,28.4),
    mk("دجاج طحينية","غدا",807.2,56,20,54.2),
    mk("دجاج مسخن","غدا",340,50,6,12.8),
    mk("دجاج كريمة","غدا",340,48,8,12.8),
    mk("دجاج مسالا","غدا",410,50,14,17.2),
    mk("برسكت لحم","غدا",396,44,14,18.2),
    mk("دجاج زعفران","غدا",420,48,16,18.2),
    mk("كوفته دجاج صوص أبيض","غدا",388,48,12,16.4),
    mk("ستيك بارتبيلو","غدا",336,50,6,12.4),
    mk("دجاج تكا مسالا","غدا",214,42,2,4.2),
    mk("دجاج كانتون","غدا",468,46,10,28),
    mk("دجاج ماشروم","غدا",404,46,16,17.4),
    mk("بيكاتا تندوري","غدا",442,56,8,20.2),
    mk("أوشن فيليه","غدا",436,48,12,24.4),
    mk("تشكن إيطالينو","غدا",532,54,8,34.2),
    mk("دجاج برياني (٢)","غدا",214,40,4,4.2),
    mk("دجاج جوز الهند المشوي","غدا",916,60,24,64.4),
    mk("دجاج مقلوبة","غدا",368,52,8,14.2),
    mk("سلطة فتوش","غدا",95,2,16,3),
    mk("سلطة خضراء","غدا",50,2,6,2),
    mk("سلطة تبولة","غدا",220,5,32,8),
    mk("سلطة فواكه","غدا",130,1.5,32,1),
    mk("قطع فواكه مشكلة","غدا",130,1.5,32,1),
    mk("سلطة الذرة","غدا",145,3.5,22,4),
    mk("جرجير والرمان","غدا",70,2,8,2.5),
    mk("سلطة بالفاصوليا","غدا",105,5,15,2.5),
    mk("سلطة ستاندر","غدا",45,1.5,5,1.5),
    mk("سلطة شمندر","غدا",60,2,12,0),
    mk("سلطة السيزر","غدا",110,7,9,5),
    mk("سلطة يونانية","غدا",110,4.5,7,7),
    mk("سلطة جرجير","غدا",35,1.5,4,1.5),
    mk("مكرونة سباغتي","غدا",310,11,62,2),
    mk("مكرونة صوص أحمر","غدا",300,10,56,4),
    mk("مكرونة مكسيكي","غدا",340,12,56,8),
    mk("بيستو باستا","غدا",440,14,54,18),
    mk("بطاطس مشوية","غدا",190,5,42,0.4),
    mk("بطاطس مهروسة","غدا",220,4,36,6),
    mk("كشري","غدا",320,10,62,4),
    mk("ماك آند تشيز","غدا",420,16,48,18),
    mk("أرز أبيض","غدا",260,5,56,0.6),
    mk("أرز برياني","غدا",320,6,60,6),
    mk("أرز صيني","غدا",340,8,60,8),
    mk("أرز كبسة أحمر","غدا",290,6,60,2),
    mk("أرز زعفران","غدا",300,6,62,4),
    mk("أرز أمريكي","غدا",260,5,56,0.6),
    mk("أرز أمريكي أحمر","غدا",280,6,58,2),
    mk("رز مندي","غدا",310,6,62,4),
    mk("رز بخاري","غدا",300,6,62,4),
    mk("رز صيادية","غدا",310,6,62,4),
    mk("رز سبانخ","غدا",290,6,58,4),
    mk("مكرونة ألفريدو","غدا",380,12,48,16),
  ];
}
