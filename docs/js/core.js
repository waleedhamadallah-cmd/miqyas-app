...
function defaultFoods(){
  const mk = (name,foodType,calories,protein,carbs,fat)=>({id:uid(),name,foodType,calories,protein,carbs,fat,fiber:0,sodium:0,favorite:false,usageCount:0});
  ...
  return [
    mk("كرات اللحم","protein",470.8,40,10,30),
    mk("لحم شيلي","protein",456,48,10,24),
    mk("لحم ستيك مع مشروم","protein",510,56,8,30),
    mk("ستيك مع صوص الفلفل الأسود","protein",475.8,54,6,28),
    mk("دجاج باربيكيو","protein",402.6,56,12,14),
    mk("دجاج برياني","protein",368,48,10,16),
    mk("دجاج تندوري","protein",573.4,60,12,34.8),
    mk("دجاج مشوي","protein",374,60,4,14),
    mk("دجاج ليمون","protein",368,56,8,12),
    mk("دجاج كريسبي","protein",420,36,24,20),
    mk("دجاج شيلي","protein",374,50,12,14),
    mk("دجاج أبولو","protein",420,48,12,20),
    mk("دجاج فاهيتا","protein",426,54,14,16),
    mk("لحم بامية","protein",396,44,14,18.2),
    mk("دجاج بيتزا","protein",420,48,16,18.2),
    mk("دجاج بامية","protein",388,48,12,16.4),
    mk("دجاج زعتر","protein",336,50,6,12.4),
    mk("صالونة سمك هامور","protein",214,42,2,4.2),
    mk("كفتة دجاج","protein",468,46,10,28),
    mk("دجاج كبسة","protein",404,46,16,17.4),
    mk("شيش طاووق","protein",442,56,8,20.2),
    mk("لحم فاهيتا","protein",436,48,12,24.4),
    mk("ستيك لحم بالصوص الأبيض","protein",532,54,8,34.2),
    mk("روبيان بالزعفران","protein",214,40,4,4.2),
    mk("دجاج مندي","protein",380,54,6,14),
    mk("دجاج رانش","protein",368,52,8,14.2),
    mk("دجاج سيشوان","protein",487,48,18,25.6),
    mk("سلمون مشوي","protein",506,50,0,34),
    mk("دجاج مع ملوخية","protein",394,50,12,16),
    mk("دجاج زبده","protein",545,48,16,33),
    mk("كباب دجاج","protein",374,52,6,16),
    mk("دجاج بالكاري","protein",582.6,48,16,37.2),
    mk("جمبري مشوي","protein",360,64,4,9.8),
    mk("صالونة سمك فيليه","protein",274,46,4,9.2),
    mk("روبيان مع صوص الليمون والشبت","protein",471.88,50,12,28.4),
    mk("دجاج طحينية","protein",807.2,56,20,54.2),
    mk("دجاج مسخن","protein",340,50,6,12.8),
    mk("دجاج كريمة","protein",340,48,8,12.8),
    mk("دجاج مسالا","protein",410,50,14,17.2),
    mk("برسكت لحم","protein",396,44,14,18.2),
    mk("دجاج زعفران","protein",420,48,16,18.2),
    mk("كوفته دجاج صوص أبيض","protein",388,48,12,16.4),
    mk("ستيك بارتبيلو","protein",336,50,6,12.4),
    mk("دجاج تكا مسالا","protein",214,42,2,4.2),
    mk("دجاج كانتون","protein",468,46,10,28),
    mk("دجاج ماشروم","protein",404,46,16,17.4),
    mk("بيكاتا تندوري","protein",442,56,8,20.2),
    mk("أوشن فيليه","protein",436,48,12,24.4),
    mk("تشكن إيطالينو","protein",532,54,8,34.2),
    mk("دجاج برياني (٢)","protein",214,40,4,4.2),
    mk("دجاج جوز الهند المشوي","protein",916,60,24,64.4),
    mk("دجاج مقلوبة","protein",368,52,8,14.2),
    mk("سلطة فتوش","salad",95,2,16,3),
    mk("سلطة خضراء","salad",50,2,6,2),
    mk("سلطة تبولة","salad",220,5,32,8),
    mk("سلطة فواكه","salad",130,1.5,32,1),
    mk("قطع فواكه مشكلة","salad",130,1.5,32,1),
    mk("سلطة الذرة","salad",145,3.5,22,4),
    mk("جرجير والرمان","salad",70,2,8,2.5),
    mk("سلطة بالفاصوليا","salad",105,5,15,2.5),
    mk("سلطة ستاندر","salad",45,1.5,5,1.5),
    mk("سلطة شمندر","salad",60,2,12,0),
    mk("سلطة السيزر","salad",110,7,9,5),
    mk("سلطة يونانية","salad",110,4.5,7,7),
    mk("سلطة جرجير","salad",35,1.5,4,1.5),
    mk("مكرونة سباغتي","carb",310,11,62,2),
    mk("مكرونة صوص أحمر","carb",300,10,56,4),
    mk("مكرونة مكسيكي","carb",340,12,56,8),
    mk("بيستو باستا","carb",440,14,54,18),
    mk("بطاطس مشوية","carb",190,5,42,0.4),
    mk("بطاطس مهروسة","carb",220,4,36,6),
    mk("كشري","carb",320,10,62,4),
    mk("ماك آند تشيز","carb",420,16,48,18),
    mk("أرز أبيض","carb",260,5,56,0.6),
    mk("أرز برياني","carb",320,6,60,6),
    mk("أرز صيني","carb",340,8,60,8),
    mk("أرز كبسة أحمر","carb",290,6,60,2),
    mk("أرز زعفران","carb",300,6,62,4),
    mk("أرز أمريكي","carb",260,5,56,0.6),
    mk("أرز أمريكي أحمر","carb",280,6,58,2),
    mk("رز مندي","carb",310,6,62,4),
    mk("رز بخاري","carb",300,6,62,4),
    mk("رز صيادية","carb",310,6,62,4),
    mk("رز سبانخ","carb",290,6,58,4),
    mk("مكرونة ألفريدو","carb",380,12,48,16),

    mk("تشيز كيك مانجو","snack",379.9,6,42,21),
    mk("تشيز كيك شوكلت","snack",248.72,5,28,14),
    mk("تشيز كيك توت أزرق","snack",266.6,5,30,15),
    mk("بودنق رايس","snack",136.67,4,22,3),
    mk("كنافة صحية","snack",318.54,7,38,15),
    mk("عريكة صحية","snack",248,5,35,10),
    mk("كيك ليمون","snack",167,3,26,5),
    mk("كيك ريد فلفيت","snack",167,3,24,7),
    mk("تشيز كيك توت","snack",298,6,32,16),
    mk("كرات الطاقة","snack",190,5,18,10),
    mk("كيك براوني","snack",120,2,16,5),
    mk("كنافة رول","snack",113,2,14,5),
    mk("سناك مكسرات","snack",130,4,8,10),
    mk("كنافة كرانش","snack",125,3,15,6),
    mk("بسبوسة صحية","snack",105,2,18,3),
    mk("تشيز كيك فراولة","snack",379.9,6,40,22),
    mk("كيك شوكلت","snack",167,3,24,7),
  ];
}
